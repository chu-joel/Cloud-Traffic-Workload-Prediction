...
class Options(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--dimensions', type=int,
                                 help='Number of features/dimensions in the input data')
        # Training process
        ...
        self.parser.add_argument('--patience', type=int, default=3,
                                 help='For stopping early. Patience is the number of epochs with no improvement after which training will be stopped')
