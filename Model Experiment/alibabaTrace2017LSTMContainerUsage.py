...
df = pd.read_csv('container_usage.csv', names=['timestamp', 'instance_id', 'cpus',
                                               'memory', 'disk', 'oneMinute', 'fiveMinute', 'fifteenMinute',
...
cpus = df.fifteenMinute.values.reshape(-1, 1)
